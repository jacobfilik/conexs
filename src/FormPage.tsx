...
function FormPage(props: formProps) {
    ...
    function formDataProcessing(formData: { 
        ...
        if (formData.Technique == "XAS") {
            formOutput += '! ' + formData.Functional + ' DKH2 ' + formData.Basis + ' SARC/J '
            ...
            formOutput += 'orbWin[0] = ' + formData["OrbWin[0] Start"] + ',' + formData["OrbWin[0] Stop"] + ',-1,-1' + "\n"
            formOutput += 'orbWin[1] = ' + formData["OrbWin[1] Start"] + ',' + formData["OrbWin[1] Stop"] + ',-1,-1' + "\n"
            ...
            formOutput = '! UKS ' + formData.Functional + ' DKH2 ' + formData.Basis + ' SARC/J '
            if (formData.Solvent != "None") {
                formOutput += 'CPCM(' + formData.Solvent + ') '
            }
            formOutput += '%maxcore 5024' + "\n\n"
        ...
        if (formData.Solvent != 'None') {
            ...
            formOutput += 'epsilon ' + solventArr[0] + ' # Dielectric constant' + "\n"
